...
const RightDrawer = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-hidden">
      {/* Backdrop — blurs and dims content behind the drawer */}
      <div 
      ...
      {/* Drawer — solid white, no transparency */}
      <div className="absolute right-0 top-0 h-full flex">
        <div 
          className={cn(
            "relative h-full bg-white border-l border-slate-200 shadow-[0_20px_60px_rgba(15,23,42,0.22)] transform transition-all duration-300 ease-out flex flex-col",
            sizeClasses[size],
            className,
